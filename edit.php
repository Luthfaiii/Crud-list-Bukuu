        ...
        <form action="process.php" method="post">
            ...
            <div class="form-elemnt my-4">
                <select name="type" id="" class="form-control">
                    ...
                    <option value="Petualangan" <?php if($row["type"]=="Petualangan"){echo "selected";} ?>>Adventure</option>
                    <option value="Komedi" <?php if($row["type"]=="Komedi"){echo "selected";} ?>>Crime</option>
                    <option value="Novel" <?php if($row["type"]=="Novel"){echo "selected";} ?>>Fantasy</option>
